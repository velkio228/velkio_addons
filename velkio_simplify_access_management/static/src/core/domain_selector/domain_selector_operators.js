...
import { formatValue, toValue } from "@velkio_simplify_access_management/core/domain_tree";
import { sprintf } from "@web/core/utils/strings";
import { parseExpr } from "@web/core/py_js/py";

/**
 * @typedef {Object} OperatorInfo
 * @property {import("@velkio_simplify_access_management/core/domain_tree").Value} operator
...
/**
 * @param {import("@velkio_simplify_access_management/core/domain_tree").Value} operator
...
/**
 * @param {import("@velkio_simplify_access_management/core/domain_tree").Value[]} operators
 * @returns {(OperatorInfo)[]}
 */
